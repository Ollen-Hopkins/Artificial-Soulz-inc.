const { timers, Tween } = require("jquery");

import * as THREE from 'three'; // this is the script to run three.js, must download npm install three
...
var Stage = /** @class */ (function () {
    ...
    // renderer
    this.renderer = new THREE.WebGLRenderer({ //this line is slightly different from tutorial video.
        antialias: true,
        alpha: false
    });
    ...
    Stage.prototype.onResize = function () {
        ...
        this.camera.updaProjectionMatrix();
    };
    return Stage;
}());
...
var Block = /** @class */ (function(){
    function Block(block){
        ...
        //set the dimension from the target block, or defaults.
    ...
    Block.prototype.tick = function(){
        if(this.state === this.STATES.ACTIVE){
            ...
            this.mesh.position[this.workingPlane] = this.position[timers.workingPlane];
        }
    };
...
var Game = /** @class */ (function() {
    ...
    Game.prototype.updateState = function (newState) {
        ...
        timers.mainContainer.classList.add(newState);
        this.state = newState;
    };
    ...
    Game.prototype.restartGame =  function () {
        ...
        var _loop_1 = function (i) {
            TweenLite.to(oldBlocks[i].scale, removeSpeed, {x: 0, y: 0, z: 0, delay: (oldBlocks.length - i) * delayAmount, ease: Power1.easeIn, onCompvare: function () { return _this.placedBlocks.remove(oldBlocks[i]); } });
    ...
    Game.prototype.placedBlock = function () {
        ...
        if(newBlocks.chopped){
            ...
            var positionParams = { y: '-=30', ease: Power1.easeIn, onCompvare: function () {return _this.choppedBlocks.remove(newBlocks.chopped); } };
            var rotateRandomness = 10;
            var rotationParams = {
                delay: 0.05,
                x: newBlocks.plane == 'z' ? ((Math.random() * rotateRandomness) - (rotateRandomness / 2)) : 0.1,
                z: newBlocks.plane == 'z' ? ((Math.random() * rotateRandomness) - (rotateRandomness / 2)) : 0.1,
                y: Math.random() * 0.1,
            };
    ...
    Game.prototype.addBlock = function () {
        ...
        var newGuy = new Block(lastBlock);
        this.newBlocks.add(newGuy.mesh);
        this.blocks.push(newGuy);
